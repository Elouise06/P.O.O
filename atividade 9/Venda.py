...
class Venda:
    ...
    # Método para converter a venda em um formato que pode ser serializado em JSON
    def to_dict(self):
        produtos_dict = [produto.to_dict() for produto in self.__produtos]  # Converte os produtos para dicionários
        return {
    ...
    # Método estático para salvar todas as vendas em um arquivo JSON
    @staticmethod
    def salvarVendasEmJson(vendas, arquivo):
